...
Equipo Should Be Visible
    ...
    Wait For Elements State    css=tr >> text=${equipo_name}    visible    5    Equipo Não encontrada

Equipo Not Should Be Visible
    [Arguments]    ${equipo_name}    

    Wait For Elements State    css=tr >> text=${equipo_name}    detached    5    Equipo Não encontrada


Alert Form Should Be
     [Arguments]       ${expect_message}

    Wait For Elements State     css=.alert-form >> text=${expect_message}   visible    5
